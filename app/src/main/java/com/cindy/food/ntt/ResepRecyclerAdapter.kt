...
import com.cindy.food.ntt.DetilResep
import com.cindy.food.ntt.ListObjResep
import kotlinx.android.synthetic.main.layout_list_ntt.view.*
...
class ResepRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ResepViewHolder(
                LayoutInflater.from(parent.context).inflate(R.layout.layout_list_ntt, parent, false)
        )
    }
