...
import com.cindy.food.kalimantanselatan.DetilResep
import com.cindy.food.kalimantanselatan.ListObjResep
import kotlinx.android.synthetic.main.layout_list_kalimantanselatan.view.*
...
class ResepRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ResepViewHolder(
                LayoutInflater.from(parent.context).inflate(R.layout.layout_list_kalimantanselatan, parent, false)
        )
    }
