...
import com.cindy.food.kepulauanriau.DetilResep
import com.cindy.food.kepulauanriau.ListObjResep
import kotlinx.android.synthetic.main.layout_list_kepulauanriau.view.*
...
class ResepRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ResepViewHolder(
                LayoutInflater.from(parent.context).inflate(R.layout.layout_list_kepulauanriau, parent, false)
        )
    }
