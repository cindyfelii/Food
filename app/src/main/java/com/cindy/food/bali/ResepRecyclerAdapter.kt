...
import com.cindy.food.bali.DetilResep
import com.cindy.food.bali.ListObjResep
import kotlinx.android.synthetic.main.layout_list_bali.view.*
...
class ResepRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ResepViewHolder(
                LayoutInflater.from(parent.context).inflate(R.layout.layout_list_bali, parent, false)
        )
    }
