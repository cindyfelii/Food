...
import com.cindy.food.sumaterautara.DetilResep
import com.cindy.food.sumaterautara.ListObjResep
import kotlinx.android.synthetic.main.layout_list_sumaterautara.view.*
...
class ResepRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ResepViewHolder(
                LayoutInflater.from(parent.context).inflate(R.layout.layout_list_sumaterautara, parent, false)
        )
    }
