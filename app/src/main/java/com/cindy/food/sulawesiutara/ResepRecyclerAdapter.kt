...
import com.cindy.food.sulawesiutara.DetilResep
import com.cindy.food.sulawesiutara.ListObjResep
import kotlinx.android.synthetic.main.layout_list_sulawesiutara.view.*
...
class ResepRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ResepViewHolder(
                LayoutInflater.from(parent.context).inflate(R.layout.layout_list_sulawesiutara, parent, false)
        )
    }
