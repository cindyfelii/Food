...
import com.cindy.food.jawatimur.DetilResep
import com.cindy.food.jawatimur.ListObjResep
import kotlinx.android.synthetic.main.layout_list_jawatimur.view.*
...
class ResepRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ResepViewHolder(
                LayoutInflater.from(parent.context).inflate(R.layout.layout_list_jawatimur, parent, false)
        )
    }
