package com.cindy.food.jawabarat
...
import com.cindy.food.jawabarat.DetilResep
import com.cindy.food.jawabarat.ListObjResep
import kotlinx.android.synthetic.main.layout_list_jawabarat.view.*
...
class ResepRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ResepViewHolder(
                LayoutInflater.from(parent.context).inflate(R.layout.layout_list_jawabarat, parent, false)
        )
    }
