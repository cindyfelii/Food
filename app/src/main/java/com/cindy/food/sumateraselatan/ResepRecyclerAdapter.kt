...
import com.cindy.food.sumateraselatan.DetilResep
import com.cindy.food.sumateraselatan.ListObjResep
import kotlinx.android.synthetic.main.layout_list_sumateraselatan.view.*
...
class ResepRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ResepViewHolder(
                LayoutInflater.from(parent.context).inflate(R.layout.layout_list_sumateraselatan, parent, false)
        )
    }
