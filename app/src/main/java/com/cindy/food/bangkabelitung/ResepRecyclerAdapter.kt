...
import com.cindy.food.bangkabelitung.DetilResep
import com.cindy.food.bangkabelitung.ListObjResep
import kotlinx.android.synthetic.main.layout_list_bangkabelitung.view.*
...
class ResepRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ResepViewHolder(
                LayoutInflater.from(parent.context).inflate(R.layout.layout_list_bangkabelitung, parent, false)
        )
    }
