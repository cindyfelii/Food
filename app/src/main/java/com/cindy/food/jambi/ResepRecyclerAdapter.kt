...
import com.cindy.food.jambi.DetilResep
import com.cindy.food.jambi.ListObjResep
import kotlinx.android.synthetic.main.layout_list_jambi.view.*
...
class ResepRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ResepViewHolder(
                LayoutInflater.from(parent.context).inflate(R.layout.layout_list_jambi, parent, false)
        )
    }
