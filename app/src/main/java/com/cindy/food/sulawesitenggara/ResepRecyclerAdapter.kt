...
import com.cindy.food.sulawesitenggara.DetilResep
import com.cindy.food.sulawesitenggara.ListObjResep
import kotlinx.android.synthetic.main.layout_list_sulawesitenggara.view.*
...
class ResepRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ResepViewHolder(
                LayoutInflater.from(parent.context).inflate(R.layout.layout_list_sulawesitenggara, parent, false)
        )
    }
