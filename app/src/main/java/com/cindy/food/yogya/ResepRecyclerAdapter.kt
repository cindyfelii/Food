...
import com.cindy.food.yogya.DetilResep
import com.cindy.food.yogya.ListObjResep
import kotlinx.android.synthetic.main.layout_list_yogya.view.*
...
class ResepRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ResepViewHolder(
                LayoutInflater.from(parent.context).inflate(R.layout.layout_list_yogya, parent, false)
        )
    }
