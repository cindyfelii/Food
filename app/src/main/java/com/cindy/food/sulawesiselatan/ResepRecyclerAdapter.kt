...
import com.cindy.food.sulawesiselatan.DetilResep
import com.cindy.food.sulawesiselatan.ListObjResep
import kotlinx.android.synthetic.main.layout_list_sulawesiselatan.view.*
...
class ResepRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ResepViewHolder(
                LayoutInflater.from(parent.context).inflate(R.layout.layout_list_sulawesiselatan, parent, false)
        )
    }
