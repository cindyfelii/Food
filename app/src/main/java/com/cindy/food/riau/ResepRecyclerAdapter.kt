...
import com.cindy.food.riau.DetilResep
import com.cindy.food.riau.ListObjResep
import kotlinx.android.synthetic.main.detil_resep.view.*
...
class ResepRecyclerAdapter: RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ResepViewHolder(
                LayoutInflater.from(parent.context).inflate(R.layout.layout_list_riau, parent, false)
        )
    }
