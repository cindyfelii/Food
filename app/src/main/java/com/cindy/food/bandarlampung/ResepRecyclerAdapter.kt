...
import com.cindy.food.bandarlampung.DetilResep
import com.cindy.food.bandarlampung.ListObjResep
import kotlinx.android.synthetic.main.layout_list_bandarlampung.view.*
...
class ResepRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ResepViewHolder(
                LayoutInflater.from(parent.context).inflate(R.layout.layout_list_bandarlampung, parent, false)
        )
    }
