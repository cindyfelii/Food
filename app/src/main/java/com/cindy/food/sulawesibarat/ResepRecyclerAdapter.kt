...
import com.cindy.food.sulawesibarat.DetilResep
import com.cindy.food.sulawesibarat.ListObjResep
import kotlinx.android.synthetic.main.layout_list_sulawesibarat.view.*
...
class ResepRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ResepViewHolder(
                LayoutInflater.from(parent.context).inflate(R.layout.layout_list_sulawesibarat, parent, false)
        )
    }
