...
import com.cindy.food.kalimantantimur.DetilResep
import com.cindy.food.kalimantantimur.ListObjResep
import kotlinx.android.synthetic.main.layout_list_kalimantantimur.view.*
...
class ResepRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ResepViewHolder(
                LayoutInflater.from(parent.context).inflate(R.layout.layout_list_kalimantantimur, parent, false)
        )
    }
