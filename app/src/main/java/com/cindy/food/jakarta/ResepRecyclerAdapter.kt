...
import com.cindy.food.jakarta.DetilResep
import com.cindy.food.jakarta.ListObjResep
import kotlinx.android.synthetic.main.layout_list_jakarta.view.*
...
class ResepRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ResepViewHolder(
                LayoutInflater.from(parent.context).inflate(R.layout.layout_list_jakarta, parent, false)
        )
    }
